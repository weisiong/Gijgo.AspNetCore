...
namespace Gijgo.Asp.NetCore.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Location>().HasData(new Location { ID = 1, ParentID = null, Name = "Asia", OrderNumber = 1, Population = null },
            ...
            modelBuilder.Entity<Player>().HasData(new Player { ID = 1, Name = "Hristo Stoichkov", PlaceOfBirth = "Plovdiv, Bulgaria", DateOfBirth = new System.DateTime(1966, 02, 08), OrderNumber = 1, CountryID = 18, IsActive = false },
            ...
            modelBuilder.Entity<PlayerTeam>().HasData(
                new PlayerTeam { ID = 1, PlayerID = 1, FromYear = 1982, ToYear = 1984, Team = "Hebros Harmanli", Apps = 32, Goals = 14 },
                new PlayerTeam { ID = 2, PlayerID = 1, FromYear = 1984, ToYear = 1990, Team = "CSKA Sofia", Apps = 119, Goals = 81 },
                new PlayerTeam { ID = 3, PlayerID = 1, FromYear = 1990, ToYear = 1995, Team = "Barcelona", Apps = 149, Goals = 77 },
                new PlayerTeam {  ID = 4, PlayerID = 1, FromYear = 1995, ToYear = 1996, Team = "Parma", Apps = 23, Goals = 5 },
                new PlayerTeam {  ID = 5, PlayerID = 1, FromYear = 1996, ToYear = 1998, Team = "Barcelona", Apps = 26, Goals = 7 },
                new PlayerTeam {  ID = 6, PlayerID = 1, FromYear = 1998, ToYear = 1998, Team = "CSKA Sofia", Apps = 4, Goals = 1 },
                new PlayerTeam {  ID = 7, PlayerID = 1, FromYear = 1998, ToYear = 1998, Team = "Al-Nassr", Apps = 2, Goals = 1 },
                new PlayerTeam {  ID = 8, PlayerID = 1, FromYear = 1998, ToYear = 1999, Team = "Kashiwa Reysol", Apps = 27, Goals = 12 },
                new PlayerTeam {  ID = 9, PlayerID = 1, FromYear = 2000, ToYear = 2002, Team = "Chicago Fire", Apps = 51, Goals = 17 },
                new PlayerTeam {  ID = 10, PlayerID = 1, FromYear = 2003, ToYear = 2003, Team = "D.C. United", Apps = 21, Goals = 5 },
                new PlayerTeam {  ID = 11, PlayerID = 2, FromYear = 1993, ToYear = 1994, Team = "Cruzeiro", Apps = 14, Goals = 12 },
                new PlayerTeam {  ID = 12, PlayerID = 2, FromYear = 1994, ToYear = 1996, Team = "PSV", Apps = 46, Goals = 42 },
                new PlayerTeam {  ID = 13, PlayerID = 2, FromYear = 1996, ToYear = 1997, Team = "Barcelona", Apps = 37, Goals = 34 },
                new PlayerTeam {  ID = 14, PlayerID = 2, FromYear = 1997, ToYear = 2002, Team = "Inter Milan", Apps = 68, Goals = 49 },
                new PlayerTeam {  ID = 15, PlayerID = 2, FromYear = 2002, ToYear = 2007, Team = "Real Madrid", Apps = 127, Goals = 83 },
                new PlayerTeam {  ID = 16, PlayerID = 2, FromYear = 2007, ToYear = 2008, Team = "Milan", Apps = 20, Goals = 9 },
                new PlayerTeam {  ID = 17, PlayerID = 2, FromYear = 2009, ToYear = 2011, Team = "Corinthians", Apps = 31, Goals = 18 },
                new PlayerTeam {  ID = 18, PlayerID = 3, FromYear = 1985, ToYear = 1988, Team = "Crewe Alexandra", Apps = 134, Goals = 56 },
                new PlayerTeam {  ID = 19, PlayerID = 3, FromYear = 1988, ToYear = 1991, Team = "Aston Villa", Apps = 121, Goals = 50 },
                new PlayerTeam {  ID = 20, PlayerID = 3, FromYear = 1991, ToYear = 1992, Team = "Bari", Apps = 29, Goals = 11 },
                new PlayerTeam {  ID = 21, PlayerID = 3, FromYear = 1992, ToYear = 1993, Team = "Juventus", Apps = 16, Goals = 3 },
                new PlayerTeam {  ID = 22, PlayerID = 3, FromYear = 1993, ToYear = 1995, Team = "Sampdoria", Apps = 55, Goals = 17 },
                new PlayerTeam {  ID = 23, PlayerID = 3, FromYear = 1995, ToYear = 1998, Team = "Arsenal", Apps = 88, Goals = 13 },
                new PlayerTeam {  ID = 24, PlayerID = 3, FromYear = 1999, ToYear = 2001, Team = "Nottingham Forest", Apps = 5, Goals = 1 });
